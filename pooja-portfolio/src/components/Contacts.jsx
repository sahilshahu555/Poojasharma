...
export const Contacts = () => {
  const phoneNumber = '+91-11111111111';
  ...
  return (
    <div id="contact" style={styles.container}>
     ...
     data-aos-duration="1000" id="contact-linkedin" target='_blank' href="https://www.linkedin.com"><i class="fa-brands fa-linkedin  fa-2xl"></i></a>
          <a style={styles.socialMediaLink} target='_blank' data-aos="fade-up"
     data-aos-duration="1000" id="contact-github" href="https://github.com"><i class="fa-brands fa-github fa-2xl"></i></a>
        </div>
      </div>
      <div> <p style={{fontWeight:"700"}}  
    >Designed <span style={{color:"orangered"}}>  &</span> develop by <span style={{color:"orangered"}}> Pooja Sharma <span style={{color:"green"}}> ©</span>  </span> 2023</p> </div>
    </div>
  );
};
